...
void SlickButtonControl::Draw()
{
    ...
    if (m_u8Timeout != 0u) {
        ...
        if (IsInFocus()) {
            ...
            stRect.u32ineColor
                = RGB_COLOR((uint32_t)(MAX_RED * 0.10), (uint32_t)(MAX_GREEN * 0.10), (uint32_t)(MAX_BLUE * 0.10));
            ;
        }
    }
    ...
    if (m_u8Timeout != 0u) {
        ...
        if (IsInFocus()) {
            ...
            stRect.u32ineColor
                = RGB_COLOR((uint32_t)(MAX_RED * 0.20), (uint32_t)(MAX_GREEN * 0.20), (uint32_t)(MAX_BLUE * 0.20));
        }
    }
